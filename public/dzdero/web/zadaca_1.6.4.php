...
<!--                <input type="file" name="datoteka1" value=""/><br>
                <input type="file" name="datoteka2" value=""/><br>
                <input type="file" name="datoteka3" value=""/><br>
                <input type="file" name="datoteka4" value=""/><br>
                <input type="file" name="datoteka5" value=""/><br>-->
