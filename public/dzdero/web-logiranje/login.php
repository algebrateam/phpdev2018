      ...
      <form role="form" action="#" method="post">
			<fieldset>
				...
				<div class="form-group">
                                    <input type="email" name="email" required="thrue" id="email" class="form-control input-lg" placeholder="Email Address" value="<?php if (isset($_COOKIE['cookie_name'])) {
          echo $_COOKIE['cookie_name'];
      } ?>">
				</div>
				<div class="form-group">
                    <input type="password" name="password" required="thrue" id="password" class="form-control input-lg" placeholder="Password" value="<?php if (isset($_COOKIE['cookie_pass'])) {
