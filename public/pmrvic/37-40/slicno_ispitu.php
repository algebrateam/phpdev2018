            ...
            <ul class="timeline">
              ...
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">
                      <!--  Nasa tablica koju smo insertali u template -->
<?php
...
$probniarray=
  [[1, 'Maja', 'Majic',12123123123]
  ,[2, 'Ivana', 'Ivanic',12415353453]
  ,[3, 'Kruno', 'Krunic',53415354]];

$t3=new Tablica();
$t3->setData($probniarray);
$t3->ispis();
?>
                          <table>
      <thead>
